...
export function getHoldings(holding =[], currency = 'usd', orderBy = 'market_cap_desc', sparkline = true, priceChangeperc ='7d', perPage=10, page=1 ){
return dispatch =>{
    ...
    return axios ({
        ...
        if(response.state == 200){
            ...
            let myHoldings = response.data.map((item) =>{
                // Retrieve our current holding -> current quantity
            ...
            dispatch(getHoldingsSuccess(myuHoldings))
        }else{
